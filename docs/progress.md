...
| Public parser status/preview APIs | complete | `GET /api/v1/public-parsers/status` and `POST /api/v1/public-parsers/preview` cover all five public parsers with fixture-first metadata. | Future UI/browser QA can add screenshots. |
