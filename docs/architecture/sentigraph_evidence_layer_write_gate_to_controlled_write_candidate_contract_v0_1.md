# Sentigraph Evidence Layer Write Gate to Controlled Write Candidate Contract v0.1

## A. Contract Purpose

This contract defines the governance boundary for moving from the 8W-22 local production-evidence-import-candidate-shaped boundary objects, accepted by 8W-23, toward a possible future Controlled Evidence Layer Write Candidate helper.
...
## B. Source Object Allowed from 8W-22 / 8W-23

The only allowed source for a future Controlled Evidence Layer Write Candidate discussion is the already-established 8W-22 local production evidence import candidate set accepted by 8W-23:

`sentigraph_controlled_production_evidence_import_candidate_set_v0_1`

Required source facts:

- 8W-23 decision is `ready`
- 8W-23 selected next boundary is `ready_for_8W_24_evidence_layer_write_gate_decision_docs_only`
- 8W-22 candidate set schema is `sentigraph_controlled_production_evidence_import_candidate_set_v0_1`
- 8W-22 candidate item schema is `sentigraph_controlled_production_evidence_import_candidate_v0_1`
...
A future 8W-25 helper, if separately approved, may define local evidence-layer-write-candidate-shaped objects.

Suggested future conceptual set fields:

- evidence layer write candidate set schema
- evidence layer write candidate set status
- source production evidence import candidate set schema
- source production evidence import candidate set status
- source production evidence import candidate count
- warning count
...
- source production evidence import candidate id
- source evidence lineage ids already present in 8W-22
- platform label
- evidence type label
...
These fields are design guidance only. They do not authorize implementation in 8W-24.
...
## I. Evidence Layer Write Candidate is not Report-ready Evidence
...
Future 8W-25 must carry forward:
...
Future 8W-25 must preserve this warning state until a separate human-reviewed process explicitly resolves it.
...
Any future Controlled Evidence Layer Write Candidate helper must block on:
...
If 8W-25 is explicitly approved, tests should prove:

- exact approval phrase is required before candidate creation
- exact phrase `批准 8W-25 Controlled Evidence Layer Write Candidate Helper Implementation` is accepted
...
Future 8W-25, if requested, must require this exact approval phrase:

`批准 8W-25 Controlled Evidence Layer Write Candidate Helper Implementation`

This phrase is not active implementation approval in 8W-24.

8W-24 does not approve Controlled Evidence Layer Write Candidate helper implementation.

8W-24 does not approve Evidence Layer Write Candidate creation.

8W-24 does not approve EvidenceItem creation, production EvidenceItem creation, Evidence Layer write, Review Queue Item creation, production case creation, production `analysis_run` creation, route/API/frontend behavior, reports, Sandbox/public events, or delivery runtime.
...
- approval to implement Controlled Evidence Layer Write Candidate helper logic
...
The only selected next boundary is future 8W-25 consideration after separate exact approval.
