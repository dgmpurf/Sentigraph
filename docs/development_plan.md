...
- Adapter factory exposes `get_adapter("reddit")`, `get_adapter("weibo")`, `get_adapter("bilibili")`, `get_adapter("douyin")`, `get_adapter("kuaishou")`, `get_adapter("xiaohongshu")`, and their `get_platform_adapter(...)` equivalents.
...
2. Douban
3. Toutiao
4. Real official API application packages after approval and compliance review
