...
CANDIDATE_SET_SCHEMA = "sentigraph_controlled_actual_analysis_execution_candidate_set_v0_1"
CANDIDATE_SCHEMA = "sentigraph_controlled_actual_analysis_execution_candidate_v0_1"
SUMMARY_SCHEMA = "sentigraph_controlled_actual_analysis_execution_candidate_summary_v0_1"
SOURCE_CANDIDATE_SET_SCHEMA = "sentigraph_controlled_production_analysis_run_candidate_set_v0_1"
SOURCE_CANDIDATE_SCHEMA = "sentigraph_controlled_production_analysis_run_candidate_v0_1"
PHASE = "8W-37"
APPROVAL_PHRASE = "APPROVE_8W_37_CONTROLLED_ACTUAL_ANALYSIS_EXECUTION_CANDIDATE_HELPER_IMPLEMENTATION"
SOURCE_WARN_STATUS = "production_analysis_run_candidate_set_warn_manual_review_required"
WARN_STATUS = "actual_analysis_execution_candidate_set_warn_manual_review_required"
EXPECTED_SOURCE_ANALYSIS_RUN_CANDIDATE_COUNT = 1
...
SOURCE_TRUE_FIELDS = {
    ...
    "production_analysis_run_candidate_created": "source_production_analysis_run_candidate_created_not_true",
}
...
def build_controlled_actual_analysis_execution_candidate_set(
    controlled_production_analysis_run_candidate_set: dict[str, Any] | None,
    *,
    exact_approval_phrase: str | None,
    requested_actions: list[str] | dict[str, Any] | None = None,
) -> dict[str, Any]:
    """Build one local actual-analysis-execution-candidate-shaped boundary object from an 8W-34 candidate set."""

    blockers: list[str] = []
    blockers.extend(_approval_blockers(exact_approval_phrase))
    blockers.extend(_requested_action_blockers(requested_actions))

    source_candidates = _safe_source_candidates(controlled_production_analysis_run_candidate_set)
    source_analysis_run_candidate_count = _source_analysis_run_candidate_count(
        controlled_production_analysis_run_candidate_set,
        source_candidates,
    )
    source_case_candidate_count = _source_case_candidate_count(
        controlled_production_analysis_run_candidate_set,
        source_candidates,
    )
    ...
    if not blockers:
        source_candidate_blockers = _source_candidate_blockers(source_candidates)
        blockers.extend(source_candidate_blockers)
        if not blockers:
    ...
    if blockers:
        return _base_output(
            ...
            warnings=[],
            candidate=None,
            source_candidate_set=controlled_production_analysis_run_candidate_set,
    ...
    return _base_output(
        ...
        created=True,
        blockers=[],
        warnings=_candidate_warnings(controlled_production_analysis_run_candidate_set),
        candidate=candidate,
        source_candidate_set=controlled_production_analysis_run_candidate_set,
        source_analysis_run_candidate_count=source_analysis_run_candidate_count,
        source_case_candidate_count=source_case_candidate_count,
...
create_controlled_actual_analysis_execution_candidate_set = build_controlled_actual_analysis_execution_candidate_set


def build_safe_controlled_actual_analysis_execution_candidate_summary(
    controlled_production_analysis_run_candidate_set: dict[str, Any] | None,
    *,
    exact_approval_phrase: str | None,
    requested_actions: list[str] | dict[str, Any] | None = None,
    ...
    return {
        ...
        "phase": PHASE,
        "actual_analysis_execution_candidate_set_schema": CANDIDATE_SET_SCHEMA,
        "actual_analysis_execution_candidate_set_status": candidate_set[
            "actual_analysis_execution_candidate_set_status"
        ],
        "source_production_analysis_run_candidate_set_schema": candidate_set[
            "source_production_analysis_run_candidate_set_schema"
        ],
        "source_production_analysis_run_candidate_schema": candidate_set[
        ...
        "actual_analysis_execution_candidate_count": candidate_set[
            "actual_analysis_execution_candidate_count"
        ],
        "actual_analysis_execution_candidate_created": candidate_set[
            "actual_analysis_execution_candidate_created"
        ],
        ...
        "production_analysis_run_candidate_created_upstream": candidate_set[
            "production_analysis_run_candidate_created_upstream"
        ],
...
def _base_output(
    *,
    ...
    return {
        "actual_analysis_execution_candidate_set_schema": CANDIDATE_SET_SCHEMA,
        "phase": PHASE,
        "actual_analysis_execution_candidate_set_status": status,
        "created_at": _utc_now(),
        "input_source_kind": "controlled_production_analysis_run_candidate",
        "source_production_analysis_run_candidate_set_schema": _safe_source_value(
            source_candidate_set,
            "production_analysis_run_candidate_set_schema",
        ),
        "source_production_analysis_run_candidate_schema": _source_production_analysis_run_candidate_schema(
            source_candidate_set
        ),
        ...
        "source_controlled_evidence_item_count": source_controlled_evidence_item_count,
        "actual_analysis_execution_candidate_mode": "backend_only_local_actual_analysis_execution_candidate_boundary",
        "actual_analysis_execution_candidate_count": len(candidates),
        "warning_count": _source_warning_count(source_candidate_set),
        "human_review_required": True,
        "no_automatic_trust_upgrade": True,
        "production_analysis_run_candidate_created_upstream": _truthy(
            source_candidate_set.get("production_analysis_run_candidate_created")
            if isinstance(source_candidate_set, dict)
            else False
        ),
        "actual_analysis_execution_candidate_created": created,
        "actual_analysis_execution_candidate_only": True,
        "actual_analysis_execution_started": False,
        "analysis_execution_started": False,
        "analysis_result_created": False,
        "production_analysis_run_created": False,
        ...
        "boundary_flags": {
            ...
            "local_only": True,
            "actual_analysis_execution_candidate_only": True,
            "controlled_production_analysis_run_candidate_derived_only": True,
            "human_review_required": True,
        ...
        "audit_summary": {
            "audit_schema": "sentigraph_controlled_actual_analysis_execution_candidate_audit_summary_v0_1",
            "phase": PHASE,
        ...
        "actual_analysis_execution_candidates": candidates,
    }
...
def _candidate_from_source(
    ...
    source_ids = [_safe_token(candidate.get("production_analysis_run_candidate_id")) for candidate in source_candidates]
    ...
    return {
        "actual_analysis_execution_candidate_schema": CANDIDATE_SCHEMA,
        "actual_analysis_execution_candidate_id": _actual_analysis_execution_candidate_id(source_ids),
        "source_production_analysis_run_candidate_id": source_ids[0] if source_ids else "unknown",
        "source_production_analysis_run_candidate_ids": source_ids,
        "source_production_analysis_run_candidate_count": source_analysis_run_candidate_count,
        "source_production_case_candidate_count": source_case_candidate_count,
        "source_controlled_evidence_item_count": source_controlled_evidence_item_count,
        ...
        "input_scope_summary_redacted": "controlled_local_analysis_run_candidate_summary_only",
        ...
        "intended_module_scope_labels": [
            "actual_analysis_execution_candidate_boundary",
...
def _source_candidate_set_blockers(
    ...
    if not isinstance(source_candidate_set, dict):
        return ["source_production_analysis_run_candidate_set_missing_or_not_object"]
    ...
    if source_analysis_run_candidate_count != EXPECTED_SOURCE_ANALYSIS_RUN_CANDIDATE_COUNT:
        blockers.append("source_production_analysis_run_candidate_count_not_one")
    if len(source_candidates) != EXPECTED_SOURCE_ANALYSIS_RUN_CANDIDATE_COUNT:
        blockers.append("source_production_analysis_run_candidates_count_not_one")
    ...
    for field, value in source_candidate_set.items():
        if field == "production_analysis_run_candidates":
            continue
        if field in FORBIDDEN_SOURCE_FIELDS:
            if field in SOURCE_FALSE_FIELDS and value is False:
                continue
            blockers.append(f"forbidden_source_production_analysis_run_candidate_set_field:{field}")
        elif _contains_forbidden_value(value):
            blockers.append(f"source_production_analysis_run_candidate_set_forbidden_value:{field}")
    return _dedupe(blockers)
...
def _source_candidate_blockers(source_candidates: list[dict[str, Any]]) -> list[str]:
    ...
    for candidate in source_candidates:
        if not isinstance(candidate, dict):
            blockers.append("source_production_analysis_run_candidate_not_object")
            continue
        for field, value in candidate.items():
            if field in FORBIDDEN_SOURCE_FIELDS:
                blockers.append(f"forbidden_source_production_analysis_run_candidate_field:{field}")
            elif _contains_forbidden_value(value):
                blockers.append(f"source_production_analysis_run_candidate_forbidden_value:{field}")
        if candidate.get("production_analysis_run_candidate_schema") != SOURCE_CANDIDATE_SCHEMA:
            blockers.append("source_production_analysis_run_candidate_schema_wrong")
        if candidate.get("source_production_analysis_run_candidate_count") not in (None, 1):
            blockers.append("source_candidate_analysis_run_candidate_count_not_one")
        ...
        if candidate.get("human_review_required") is not True:
            blockers.append("source_production_analysis_run_candidate_human_review_required_not_true")
        if candidate.get("no_automatic_trust_upgrade") is not True:
            blockers.append("source_production_analysis_run_candidate_no_automatic_trust_upgrade_not_true")
        if candidate.get("production_analysis_run_candidate_only") is not True:
            blockers.append("source_production_analysis_run_candidate_only_not_true")
...
def _safe_source_candidates(source_candidate_set: dict[str, Any] | None) -> list[dict[str, Any]]:
    if not isinstance(source_candidate_set, dict):
        return []
    candidates = source_candidate_set.get("production_analysis_run_candidates")
    if not isinstance(candidates, list):
        return []
    return [candidate for candidate in candidates if isinstance(candidate, dict)]


def _source_analysis_run_candidate_count(
    source_candidate_set: dict[str, Any] | None,
    source_candidates: list[dict[str, Any]],
) -> int:
    if isinstance(source_candidate_set, dict):
        count = source_candidate_set.get("production_analysis_run_candidate_count")
        if isinstance(count, int) and not isinstance(count, bool):
            return count
    return len(source_candidates)


def _source_case_candidate_count(
    source_candidate_set: dict[str, Any] | None,
    source_candidates: list[dict[str, Any]],
) -> int:
    if isinstance(source_candidate_set, dict):
...
def _source_production_analysis_run_candidate_schema(source_candidate_set: dict[str, Any] | None) -> str | None:
    candidates = _safe_source_candidates(source_candidate_set)
    if candidates:
        return _safe_label(candidates[0].get("production_analysis_run_candidate_schema"))
    return None
...
def _blocked_status(blockers: list[str]) -> str:
    if not blockers:
        return "blocked_invalid_source_production_analysis_run_candidate"
    first = blockers[0]
    if first in {
    ...
    if first.startswith("source_production_analysis_run_candidate_count") or first.startswith(
        "source_production_analysis_run_candidates_count"
    ):
    ...
    if first.startswith("source_controlled_evidence_item_count"):
        return "blocked_candidate_limit_violation"
    if first.startswith("forbidden_source") or first.startswith("source_production_analysis_run_candidate_forbidden"):
...
def _actual_analysis_execution_candidate_id(source_ids: list[str]) -> str:
    first_id = source_ids[0] if source_ids else "unknown"
    return f"controlled-actual-analysis-execution-candidate-001-{first_id}"
