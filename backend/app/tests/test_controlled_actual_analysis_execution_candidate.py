...
from app.services import controlled_actual_analysis_execution_candidate as module
from app.services.controlled_actual_analysis_execution_candidate import (
    APPROVAL_PHRASE,
    build_controlled_actual_analysis_execution_candidate_set,
    build_safe_controlled_actual_analysis_execution_candidate_summary,
)
...
NON_ASCII_APPROVAL_PHRASE = (
    "\u6279\u51c6 8W-37 Controlled Actual Analysis Execution Candidate Helper Implementation"
)
...
FORBIDDEN_SENTINELS = (
    ...
    "production-analysis-run-should-never-appear",
    "analysis-result-should-never-appear",
    "actual-analysis-execution-should-never-appear",
)
...
def _source_analysis_run_candidate(**overrides: object) -> dict[str, object]:
    candidate: dict[str, object] = {
        "production_analysis_run_candidate_schema": (
            "sentigraph_controlled_production_analysis_run_candidate_v0_1"
        ),
        "production_analysis_run_candidate_id": (
            "controlled-production-analysis-run-candidate-001-hash-001"
        ),
        "source_production_case_candidate_id": "controlled-production-case-candidate-001-hash-001",
        "source_production_case_candidate_ids": ["controlled-production-case-candidate-001-hash-001"],
        ...
        "input_scope_summary_redacted": "controlled_local_case_candidate_summary_only",
        "intended_analysis_scope_labels": [
            "selected_sample_only",
            "human_review_required",
            "no_automatic_trust_upgrade",
        ],
        "intended_module_scope_labels": [
            "analysis_run_candidate_boundary",
        ...
        "blocker_codes": [],
        "production_analysis_run_readiness_blockers": [
            "production_case_not_created",
            "human_review_required",
            "warning_state_active",
        ],
        "analysis_execution_readiness_blockers": [
            "analysis_execution_not_approved",
            "production_analysis_run_not_created",
            "human_review_required",
        ],
        ...
        "boundary_flags": {
            "production_analysis_run_candidate_only": True,
            "controlled_production_case_candidate_derived_only": True,
            "human_review_required": True,
            "warning_preserving": True,
            "no_automatic_trust_upgrade": True,
            "not_production_analysis_run": True,
            "not_analysis_execution": True,
...
def _valid_source_analysis_run_candidate_set(**overrides: object) -> dict[str, object]:
    source: dict[str, object] = {
        "production_analysis_run_candidate_set_schema": (
            "sentigraph_controlled_production_analysis_run_candidate_set_v0_1"
        ),
        "phase": "8W-34",
        "production_analysis_run_candidate_set_status": (
            "production_analysis_run_candidate_set_warn_manual_review_required"
        ),
        "input_source_kind": "controlled_production_case_candidate",
        "source_production_case_candidate_set_schema": (
            "sentigraph_controlled_production_case_candidate_set_v0_1"
        ),
        "source_production_case_candidate_schema": (
            "sentigraph_controlled_production_case_candidate_v0_1"
        ),
        "source_production_case_candidate_count": 1,
        "source_controlled_evidence_item_count": 5,
        "production_analysis_run_candidate_mode": (
        ...
        "human_review_required": True,
        "no_automatic_trust_upgrade": True,
        "production_case_candidate_created_upstream": True,
        "production_analysis_run_candidate_created": True,
        "production_analysis_run_candidate_only": True,
        "production_analysis_run_created": False,
        ...
        "blockers": [],
        "audit_summary": {
            "audit_schema": "sentigraph_controlled_production_analysis_run_candidate_audit_summary_v0_1",
            "phase": "8W-34",
            "analysis_effect": "none",
            "analysis_execution_effect": "none",
        ...
        "production_analysis_run_candidates": [_source_analysis_run_candidate()],
    }
...
def _assert_blocked(candidate_set: dict[str, object], expected_reason: str) -> None:
    assert str(candidate_set["actual_analysis_execution_candidate_set_status"]).startswith("blocked_")
    assert expected_reason in candidate_set["blockers"]
    assert candidate_set["actual_analysis_execution_candidate_created"] is False
    assert candidate_set["actual_analysis_execution_candidate_count"] == 0
    assert candidate_set["actual_analysis_execution_candidates"] == []
...
def test_ready_path_builds_one_controlled_actual_analysis_execution_candidate() -> None:
    assert APPROVAL_PHRASE == EXPECTED_APPROVAL_PHRASE
    assert APPROVAL_PHRASE.isascii()

    candidate_set = build_controlled_actual_analysis_execution_candidate_set(
        _valid_source_analysis_run_candidate_set(),
        exact_approval_phrase=EXPECTED_APPROVAL_PHRASE,
    )

    assert candidate_set["actual_analysis_execution_candidate_set_schema"] == (
        "sentigraph_controlled_actual_analysis_execution_candidate_set_v0_1"
    )
    assert candidate_set["phase"] == "8W-37"
    assert candidate_set["actual_analysis_execution_candidate_set_status"] == (
        "actual_analysis_execution_candidate_set_warn_manual_review_required"
    )
    assert candidate_set["input_source_kind"] == "controlled_production_analysis_run_candidate"
    assert candidate_set["source_production_analysis_run_candidate_set_schema"] == (
        "sentigraph_controlled_production_analysis_run_candidate_set_v0_1"
    )
    assert candidate_set["source_production_analysis_run_candidate_schema"] == (
        "sentigraph_controlled_production_analysis_run_candidate_v0_1"
    )
    ...
    assert candidate_set["actual_analysis_execution_candidate_mode"] == (
        "backend_only_local_actual_analysis_execution_candidate_boundary"
    )
    assert candidate_set["actual_analysis_execution_candidate_count"] == 1
    ...
    assert candidate_set["production_analysis_run_candidate_created_upstream"] is True
    assert candidate_set["actual_analysis_execution_candidate_created"] is True
    assert candidate_set["actual_analysis_execution_started"] is False
    assert candidate_set["analysis_execution_started"] is False
    assert candidate_set["analysis_result_created"] is False
    assert candidate_set["production_analysis_run_created"] is False
    ...
    candidates = candidate_set["actual_analysis_execution_candidates"]
    assert isinstance(candidates, list)
    assert len(candidates) == 1
    candidate = candidates[0]
    allowed_fields = {
        "actual_analysis_execution_candidate_schema",
        "actual_analysis_execution_candidate_id",
        "source_production_analysis_run_candidate_id",
        "source_production_analysis_run_candidate_ids",
        ...
        "intended_execution_scope_labels",
        "intended_module_scope_labels",
        "warning_count",
        "human_review_required",
        "review_status",
        ...
        "report_readiness_blockers",
        "actual_analysis_execution_candidate_only",
        "no_automatic_trust_upgrade",
    ...
    assert candidate["actual_analysis_execution_candidate_schema"] == (
    ...
    assert candidate["actual_analysis_execution_candidate_only"] is True
    ...
    assert "actual_analysis_execution_not_approved" in candidate[
        "actual_analysis_execution_readiness_blockers"
    ]
    assert "analysis_result_generation_not_approved" in candidate[
        "analysis_result_generation_readiness_blockers"
    ]
    assert "analysis_result_not_created" in candidate["report_readiness_blockers"]
    assert candidate["boundary_flags"]["actual_analysis_execution_candidate_only"] is True
    assert candidate["boundary_flags"]["not_actual_analysis_execution"] is True
    assert candidate["boundary_flags"]["not_analysis_result"] is True
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "APPROVE_8W_37_CONTROLLED_ACTUAL_ANALYSIS_EXECUTION_CANDIDATE_HELPER_IMPLEMENTATI0N",
...
def test_exact_ascii_approval_required_before_candidate_construction_and_file_access(
    ...
    def blocked_open(*args, **kwargs):
        raise AssertionError("8W-37 must not open files")

    def blocked_candidate(*args, **kwargs):
        raise AssertionError("8W-37 must not construct candidates on wrong approval")
...
@pytest.mark.parametrize(
    ...
    [
        (
            "production_analysis_run_candidate_set_schema",
            "wrong",
            "source_production_analysis_run_candidate_set_schema_wrong",
        ),
        (
            "production_analysis_run_candidate_set_status",
            "production_analysis_run_candidate_set_ready",
            "source_production_analysis_run_candidate_set_status_not_warn_manual_review",
        ),
        (
            "production_analysis_run_candidate_count",
            2,
        ...
        (
            "production_analysis_run_candidate_created",
            False,
            "source_production_analysis_run_candidate_created_not_true",
        ),
...
def test_source_validation_blocks_unsafe_candidate_set_fields(field: str, value: object, reason: str) -> None:
    candidate_set = build_controlled_actual_analysis_execution_candidate_set(
        _valid_source_analysis_run_candidate_set(**{field: value}),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "source_runtime_side_effect_true:started_actual_analysis_execution",
        ),
...
def test_source_runtime_side_effects_block(runtime_flag: str, reason: str) -> None:
    source = _valid_source_analysis_run_candidate_set()
...
def test_candidate_count_blocks_when_source_candidates_absent_or_malformed() -> None:
    absent = build_controlled_actual_analysis_execution_candidate_set(
        _valid_source_analysis_run_candidate_set(production_analysis_run_candidates=[]),
        exact_approval_phrase=APPROVAL_PHRASE,
    )
    _assert_blocked(absent, "source_production_analysis_run_candidates_count_not_one")

    malformed = build_controlled_actual_analysis_execution_candidate_set(
        _valid_source_analysis_run_candidate_set(production_analysis_run_candidates=[{"wrong": "shape"}]),
        exact_approval_phrase=APPROVAL_PHRASE,
    )
    _assert_blocked(malformed, "source_production_analysis_run_candidate_schema_wrong")


def test_forbidden_fields_in_source_candidate_block_or_never_emit() -> None:
    unsafe_candidate = _source_analysis_run_candidate(
        actual_analysis_execution_id="actual-analysis-execution-should-never-appear",
        analysis_execution_id="actual-analysis-execution-should-never-appear",
        analysis_result_id="analysis-result-should-never-appear",
        production_analysis_run_id="production-analysis-run-should-never-appear",
        analysis_run_id="production-analysis-run-should-never-appear",
        production_case_id="production-case-should-never-appear",
        production_evidence_item_id="production-evidence-item-should-never-appear",
        review_queue_item_id="review-queue-item-should-never-appear",
    ...
    candidate_set = build_controlled_actual_analysis_execution_candidate_set(
        _valid_source_analysis_run_candidate_set(production_analysis_run_candidates=[unsafe_candidate]),
        exact_approval_phrase=APPROVAL_PHRASE,
    )

    _assert_blocked(candidate_set, "forbidden_source_production_analysis_run_candidate_field:actual_analysis_execution_id")
...
def test_requested_side_effects_block_and_keep_flags_false(requested_action: str) -> None:
    ...
    assert candidate_set["actual_analysis_execution_candidate_set_status"].startswith("blocked_")
...
def test_safe_summary_is_counts_and_boundaries_only() -> None:
    summary = build_safe_controlled_actual_analysis_execution_candidate_summary(
        _valid_source_analysis_run_candidate_set(),
        exact_approval_phrase=APPROVAL_PHRASE,
    )

    assert summary["summary_schema"] == "sentigraph_controlled_actual_analysis_execution_candidate_summary_v0_1"
    assert summary["phase"] == "8W-37"
    assert summary["actual_analysis_execution_candidate_set_schema"] == (
        "sentigraph_controlled_actual_analysis_execution_candidate_set_v0_1"
    )
    assert summary["actual_analysis_execution_candidate_set_status"] == (
        "actual_analysis_execution_candidate_set_warn_manual_review_required"
    )
    assert summary["actual_analysis_execution_candidate_count"] == 1
    ...
    assert summary["actual_analysis_execution_candidate_created"] is True
    ...
    assert "actual_analysis_execution_candidates" not in summary
    assert "source_production_analysis_run_candidate_id" not in _serialized(summary)
