...
- Search Discovery status: `GET /api/v1/search-discovery/status` and the mock candidates endpoint expose planning/static URL-title-snippet discovery metadata only; no real search provider, URL fetch, scraping, or automatic attach is enabled.
