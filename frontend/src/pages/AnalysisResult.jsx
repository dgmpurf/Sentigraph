...
export function AnalysisResult({ analysis, error, loading, recommendation, summary, visualization }) {
    ...
    <div className="page-stack">
      <div className="page-heading">
        <div>
          ...
          <Text>{analysis.summary || '当前展示 mock-first 舆情分析结果。'}</Text>
        </div>
      ...
      <Row gutter={[16, 16]}>
        <Col span={8}>
          <Card className="panel-card risk-readout-card">
            ...
            <Paragraph>
              风险由 V1.5 话题级风险、情绪、扩散、争议和疑似重复话术信号综合生成，当前仍基于离线 mock 管线。
            </Paragraph>
          </Card>
        </Col>
        <Col span={8}>
